...
import { Video, Youtube, Twitch, Plus, Loader2, Upload, X, Search } from 'lucide-react';
    ...
    return (
        <Layout>
            <div className="ml-64 flex-1 p-6 min-h-screen">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold">Video Scraper Dashboard</h1>
                    <p className="mt-2 text-gray-400">Add video URLs to scrape and organize content</p>
                </div>
